...
{
    class TestCube : AEntity<PolyFrameEventArgs>
    {
        ...
        public TestCube(World world, Entity camera, 
        ...
        public override void Create(PolyFrameEventArgs state)
        {
            ...
            Entity.Set(ManagedResource<Texture>.Create(
                @"Resources\MinaReally.png"));
            ...
            Entity.Set(ManagedResource<Model>.Create(
                new ModelInfo(@"Resources\cube.obj")));
        }
    }
}
